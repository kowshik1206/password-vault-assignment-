  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button 
          onClick={onAddEntry}
          className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-primary-foreground bg-primary rounded-md hover:bg-primary/90 transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
        >
          Add New Entry
        </button>
      </div>
      ...
      <div className="relative">
        <input 
          ...
          className="w-full pl-10 pr-4 py-2 bg-card border rounded-md border-input focus:outline-none focus:ring-2 focus:ring-ring"
        />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
        {entries.length === 0 ? (
          <p className='col-span-full text-center text-muted-foreground'>Your vault is empty. Add a new entry to get started.</p>
        ) : filteredEntries.length === 0 ? (
          <p className='col-span-full text-center text-muted-foreground'>No entries match your search.</p>
        ) : (
